...
class GUI(tk.Frame):
    ...
    def initComponent(self):
        ...
        self.parent.title("Metodo de Taylor")
    ...
    def procesar(self):
        ...
        if len(ec)!=0 and len(x)!=0 and len(y)!=0 :
            ...
            lblMsg = tk.Label(self.parent, text="Resolver por método de Taylor:",
                                  anchor=tk.W, justify=tk.LEFT)
    ...
    def euler(self, edo):
        ...
        if len(inicial)!=0 and len(final)!=0 and len(n)!=0 :
            ...
            # obtenemos los trazos de tayor
            edo.taylor(inicial, final, n)
            ...
            # Mostramos el error
            err = edo.pec[len(edo.pec) - 1] - edo.py[len(edo.pt) - 1]
            text = "\nError Taylor:\n"+str(err)
            err = edo.pec[len(edo.pec) - 1] - edo.pt[len(edo.py) - 1]
            text += "\nError Euler:\n"+str(err)
