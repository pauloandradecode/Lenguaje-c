 ...
 */
public class DivPanel extends JPanel implements ActionListener, KeyListener, MouseListener
{
    ...
    public DivPanel(Aritmetica frame)
    {
        super(); // constructor padre
        root = frame;
        num1 = (int) (random() * 99) + 1; // Generamos numeros aleatorios
        num2 = (int) (random() * 9) + 2;
        while(num1 % num2 != 0){
    ...
    public void initComponent()
    {
        ...
        String txt = "División " + Aritmetica.ctrSuma + " de " + 5;
        ...
        lblNum1.setFont(new Font(lblInstruccion.getFont().getName(), Font.BOLD, 80));
        lblNum1.setForeground(Color.GRAY);
        
        lblSigno = new JLabel("/", SwingConstants.CENTER);
        ...
        lblNum2.setFont(new Font(lblInstruccion.getFont().getName(), Font.BOLD, 80));
