 ...
 */
public class RestaPanel extends JPanel implements ActionListener, KeyListener, MouseListener
{
    ...
    public RestaPanel(Aritmetica frame)
    {
    ...
    public void initComponent()
    {
        ...
        String txt = "Resta " + Aritmetica.ctrSuma + " de " + 5;
