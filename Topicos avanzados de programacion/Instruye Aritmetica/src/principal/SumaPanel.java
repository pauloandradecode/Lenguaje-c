 ...
 */
public class SumaPanel extends JPanel implements ActionListener, KeyListener, MouseListener
{
    ...
    public SumaPanel(Aritmetica frame)
    {
    ...
    public void initComponent()
    {
        ...
        String txt = "Suma " + Aritmetica.ctrSuma + " de " + 5;
