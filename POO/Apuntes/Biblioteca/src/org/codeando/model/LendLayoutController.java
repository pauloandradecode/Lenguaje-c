 ...
 */
public class LendLayoutController extends ActionEvent
{
    ...
    public void newLend(ActionEvent actionEvent) throws Exception
    {
    ...
    {
        lendTable.setItems(DataBinding.getDataLend());
    }
    ...
    public void setLend(ActionEvent actionEvent) throws Exception
    {
        ...
        Libro selectedLend = lendTable.getSelectionModel().getSelectedItem();
        // Cargamos la ventana para editar
        LC.loadSetLend(selectedLend, lendTable, false);
    }
}
