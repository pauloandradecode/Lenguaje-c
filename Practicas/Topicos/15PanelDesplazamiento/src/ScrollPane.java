...
public class ScrollPane extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Panel de desplazamiento");

        lblImagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/portada.png"))); // NOI18N
        lblImagen.setToolTipText("");
        scpImagen.setViewportView(lblImagen);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(scpImagen, javax.swing.GroupLayout.DEFAULT_SIZE, 376, Short.MAX_VALUE)
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(scpImagen, javax.swing.GroupLayout.DEFAULT_SIZE, 276, Short.MAX_VALUE)
                .addContainerGap())
        );
