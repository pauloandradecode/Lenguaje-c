...
public class Ventana extends Application
{
	...
	public void start(Stage primaryStage)
	{
		...
		sceneText.setId("welcome-text"); // Añadimos un identifcador para los estilos
		...
		actionTarget.setId("action-target"); // Añadimos identificador para los estilos
		...
		btn.setOnAction(new EventHandler<ActionEvent>(){
			...
			{
				actionTarget.setText("Sign in button pressed"); // Añadimos texto
			}
		});

		grid.setGridLinesVisible(false); // Hace los bordes visibles
